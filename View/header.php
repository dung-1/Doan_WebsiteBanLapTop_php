        ...
        <div class="container">
            <div class="navbar align-items-center justify-content-between ">
                <div class=" navbar__logo">
                    <img alt="laptopaz.com chuyên laptop cũ, bán laptop cũ uy tín Hà Nội và toàn quốc" src="../public/img/icons/icon.png" class="img-fluid">
                </div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse container" id="navbarCollapse">
                        ...
                        <div class="navbar-nav ms-auto">
                            ...
                            <a href="test-register.html" class="nav-item nav-link me-4"><i class="bi bi-box-arrow-right"></i> Đăng ký</a>
